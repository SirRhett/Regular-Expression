...
/*
Explain:
The only numbers in the username have to be at the end. \d$ There can be zero 
...
*/
    /\d*$/i;
/*
Usernames have to be at least two characters long. {2,} A two-letter username 
can only use alphabet letter characters. ^[a-z]
*/
    /^[a-z]{2,}\d*$/i;
