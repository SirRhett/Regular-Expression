/*              Reuse Patterns Using Capture Groups
    ...
    manually repeat that regex. There is a better way to specify when you have multiple 
    repeat substrings in your string.

    You can search for repeat substrings using capture groups. Parentheses, ( and ), 
    are used to find repeat substrings. You put the regex of the pattern that will repeat 
...
/*
    ...
    Use capture groups in reRegex to match numbers that are repeated only three times in a string, 
